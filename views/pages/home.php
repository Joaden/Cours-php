<?php 
session_start();
    // FICHIER home.php = TEMPLATE de base
    $pathToRootFolder = "../../";
    ...
    require_once($pathToRootFolder.'src_denis/Models/Model.php');
    require_once($pathToRootFolder.'config/functions.php');
...
<?php 
    ...
    <!-- ======== Start HomeView ========= -->
    <!-- Importer le fichier indexView.php (le content du body) -->
    <?php //include($pathToRootFolder."views/common/indexView.php"); ?>
