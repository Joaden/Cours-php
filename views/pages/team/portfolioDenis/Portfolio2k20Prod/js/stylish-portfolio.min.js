...
// slide Exp
$(document).ready(function(){$("#flip").click(function(){$("#panel, #pane2, #pane3, #pane4, #panel5, #pane6").slideToggle("slow");});$("#flipA").click(function(){$("#paneA").slideToggle("slow");});  // slide portfolio
$("#flip1").click(function(){$("#carouselFade").slideToggle("slow");});$("#flip2").click(function(){$("#carouselFade1").slideToggle("slow");});$("#flip3").click(function(){$("#carouselFade2").slideToggle("slow");});}); // slide Formulaire
$('#flipForm').click(function(){$("#FormulaireC").slideToggle("slow");})